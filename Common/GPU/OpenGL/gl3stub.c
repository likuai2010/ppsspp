...
namespace gles3 {
    ...
    typedef void (*PFN_glReadBuffer)(GLenum mode);
    typedef void (*PFN_glDrawRangeElements)(GLenum mode, GLuint start, GLuint end, GLsizei count, GLenum type, const GLvoid* indices);
    typedef void (*PFN_glTexImage3D)(GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLenum format, GLenum type, const GLvoid* pixels);
    typedef void (*PFN_glTexSubImage3D)(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type, const GLvoid* pixels);
    ...
    typedef void (*PFN_glCompressedTexImage3D)(GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLsizei imageSize, const GLvoid* data);
    typedef void (*PFN_glCompressedTexSubImage3D)(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLsizei imageSize, const GLvoid* data);
    ...
    typedef void (*PFN_glGetBufferPointerv)(GLenum target, GLenum pname, GLvoid** params);
    ...
    typedef GLvoid* (*PFN_glMapBufferRange)(GLenum target, GLintptr offset, GLsizeiptr length, GLbitfield access);
    ...
    typedef void (*PFN_glVertexAttribIPointer)(GLuint index, GLint size, GLenum type, GLsizei stride, const GLvoid* pointer);
    ...
    typedef void (*PFN_glGetInteger64v)(GLenum pname, GLint64* params);
    ...
    typedef void (*PFN_glGetProgramBinary)(GLuint program, GLsizei bufSize, GLsizei* length, GLenum* binaryFormat, GLvoid* binary);
    typedef void (*PFN_glProgramBinary)(GLuint program, GLenum binaryFormat, const GLvoid* binary, GLsizei length);
    ...
    typedef void (*PFN_glBindFragDataLocationIndexedEXT)(GLuint program, GLuint colorNumber, GLuint index, const GLchar *name);
    typedef void (*PFN_glBindFragDataLocationEXT)(GLuint program, GLuint color, const GLchar *name);
    typedef GLint (*PFN_glGetProgramResourceLocationIndexEXT)(GLuint program, GLenum programInterface, const GLchar *name);
    typedef GLint (*PFN_glGetFragDataIndexEXT)(GLuint program, const GLchar *name);
    typedef void (*PFN_glBufferStorageEXT) (GLenum target, GLsizeiptr size, const void *data, GLbitfield flags);
    typedef void (*PFN_glCopyImageSubDataOES) (GLuint srcName, GLenum srcTarget, GLint srcLevel, GLint srcX, GLint srcY, GLint srcZ, GLuint dstName, GLenum dstTarget, GLint dstLevel, GLint dstX, GLint dstY, GLint dstZ, GLsizei width, GLsizei height, GLsizei depth);
    ...
    GLboolean  gl3stubInit() {
    #define FIND_PROC(s) s = (PFN_ ## s)eglGetProcAddress(#s)
    FIND_PROC(glReadBuffer);
    FIND_PROC(glDrawRangeElements);
    FIND_PROC(glTexImage3D);
    FIND_PROC(glTexSubImage3D);
