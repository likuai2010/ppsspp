...
void UIInputAxisEventCallback(OH_NativeXComponent *comp,
...
void PluginManager::Export(napi_env env, napi_value exports)
{
    ...
    if ((nullptr != context) && (nullptr != nativeXComponent)) {
        ...
        OH_NativeXComponent_RegisterUIInputEventCallback(nativeXComponent, &UIInputAxisEventCallback, ARKUI_UIINPUTEVENT_TYPE_AXIS);
        if (nullptr != render) {
