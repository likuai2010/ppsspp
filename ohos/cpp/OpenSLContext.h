...
public:
	OpenSLContext(OHOSAudioCallback cb, int framesPerBuffer, int sampleRate);
...
private:
    ...
    SLOHBufferQueueItf recorderBufferQueue = nullptr;
//	SLAndroidSimpleBufferQueueItf recorderBufferQueue = nullptr;
    ...
    static void bqRecorderCallback(SLOHBufferQueueItf bq, void *context, SLuint32 size);
//	static void bqRecorderCallback(SLAndroidSimpleBufferQueueItf bq, void *context);

	// buffer queue player interfaces
	SLObjectItf bqPlayerObject = nullptr;
	SLPlayItf bqPlayerPlay = nullptr;
	SLOHBufferQueueItf bqPlayerBufferQueue = nullptr;
	...
	static void bqPlayerCallbackWrap(SLOHBufferQueueItf bq, void *context, SLuint32 size);
	void BqPlayerCallback(SLOHBufferQueueItf bq);
};
