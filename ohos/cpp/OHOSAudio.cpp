...
bool OHOSAudio_Recording_SetSampleRate(OHOSAudioState *state, int sampleRate) {
	...
	INFO_LOG(Log::Audio, "OHOSAudio_Recording_SetSampleRate=%d", sampleRate);
	return true;
}
...
bool OHOSAudio_Recording_Start(OHOSAudioState *state) {
	...
	INFO_LOG(Log::Audio, "OHOSAudio_Recording_Start");
	return true;
}
...
bool OHOSAudio_Recording_Stop(OHOSAudioState *state) {
	...
	INFO_LOG(Log::Audio, "OHOSAudio_Recording_Stop");
	return true;
}
