...
void OpenSLContext::bqRecorderCallback(SLOHBufferQueueItf bq, void *context, SLuint32 size) {
...
OpenSLContext::OpenSLContext(OHOSAudioCallback cb, int _FramesPerBuffer, int _SampleRate)
...
bool OpenSLContext::AudioRecord_Start(int sampleRate) {
	...
	result = (*recorderObject)->GetInterface(recorderObject, SL_IID_OH_BUFFERQUEUE, (void*) &recorderBufferQueue);
